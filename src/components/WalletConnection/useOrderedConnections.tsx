...
function useEIP6963Connections() {
  ...
  const eip6963Enabled = true // useEip6963Enabled()
...
export function useOrderedConnections() {
  ...
  const orderedConnections = useMemo(() => {
    ...
    // const list= getOrderedConnections(allConnections, recentConnection)

    // console.log({
    //   name:'useOrderedConnections------------------------------',
    //   eip6963Connections,
    //   allConnections,
    //   connections,
    // //   list
